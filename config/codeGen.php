...
$req_ref_number = 'GoMC/REQ/' . date('Y') . '/' . substr(str_shuffle('QWERTYUIOPLKJHGFDSAZXCVBNM1234567890'), 1, 5);


/* Cabinet Paper Numbers */
$cabinet_paper_number = 'GoMC/CP/' . date('Y') . '/' . substr(str_shuffle('QWERTYUIOPLKJHGFDSAZXCVBNM1234567890'), 1, 5);

/* Ministerial Paper Number */
$ministerial_paper_number  = 'GoMC/MP/' . date('Y') . '/' . substr(str_shuffle('QWERTYUIOPLKJHGFDSAZXCVBNM1234567890'), 1, 5);

/* Requisition Serial Number */
$requisition_serial_number  = 'GoMC/REQ/' . date('Y') . '/' . substr(str_shuffle('QWERTYUIOPLKJHGFDSAZXCVBNM1234567890'), 1, 5);
